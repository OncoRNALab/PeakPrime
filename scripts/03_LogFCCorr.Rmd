...
#ggsave("../data/results/figures/logFC_UHRR_IMR32_label.png", pltv2, dpi=300, width = 8, height = 6)
#ggsave("../data/results/figures/logFC_UHRR_IMR32_label.pdf", pltv2, dpi=300, width = 8, height = 6)
```
