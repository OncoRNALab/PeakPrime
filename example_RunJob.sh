...
#these are the paths where the Nextflow   --outdir results/macs2_class1_v2/plots_faily caches will be stored
...
ml Nextflow/25.04.4
  ...
  --peak_selection_metric score \
  --peak_rank 1 \
  --outdir results/macs2_class1_v2
...
nextflow run main.nf -profile local --makeplots \
   ...
   --narrowpeak /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class5/macs2_peaks/Merged_S7_S12_peaks.narrowPeak \
...
nextflow run main.nf -profile local --makeplots \
   ...
   --narrowpeak /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class1/macs2_peaks/Merged_S7_S12_peaks.narrowPeak \
...
nextflow run main.nf -profile local --makeplots \
   ...
   --primer /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class2/processed_peaks/selected_peaks.bed \
   ...
   --narrowpeak /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class2/macs2_peaks/Merged_S7_S12_peaks.narrowPeak \
   --outdir results/macs2_class2/plots
...
nextflow run main.nf -profile local --makeplots \
   ...
   --narrowpeak /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class4/macs2_peaks/Merged_S7_S12_peaks.narrowPeak \
...
nextflow run main.nf -profile local --makeplots \
   --gtf /data/gent/vo/000/gvo00027/resources/Ensembl_transcriptomes/Homo_sapiens/GRCh38/Homo_sapiens.GRCh38.109.chrIS_spikes_45S.gtf \
   --genes /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/testdata/failed_class1.txt \
   --bw /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class1_v2/Merged_S7_S12.unique.bw \
   --peaks_tsv /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class1_v2/processed_peaks/selected_peaks.tsv \
   --primer_targets_bed /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class1_v2/processed_peaks/selected_peaks.bed \
   --qc_tsv /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class1_v2/processed_peaks/peaks_qc_summary.tsv \
   --narrowpeak /user/gent/446/vsc44685/ScratchVO_dir/OncoRNA_peakprime/Primer_PeakFindR/results/macs2_class1_v2/macs2_peaks/Merged_S7_S12_peaks.narrowPeak \
   --outdir results/macs2_class1_v2/plots_fail


 cat /data/gent/vo/000/gvo00027/resources/Ensembl_transcriptomes/Homo_sapiens/GRCh38/Homo_sapiens.GRCh38.109.chrIS_spikes_45S.gtf | grep 'ENSG00000166681' > ENSG00000166681.gtf